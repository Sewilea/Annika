        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if(Land != null)
            {
                ...
                if (Distance < 2 && !Player.GetComponent<Player>().Break)
                {
                    ...
                    if (Kaishi != null && Kaishi.isfull && !Kaishi.isfarm && Kaishi.Item != null && Kaishi.Item.forbreak == Chooseitem && Kaishi.Item.TypeID == 1 && Kaishi.tree.activeSelf)
                    {
                        Kaishi.treeint--;
                        ...
                        if (Kaishi.treeint < 0)
                        {
                            ...
                            AddCollectItem(Items[26], Random.Range(1, 3), MousePos);
